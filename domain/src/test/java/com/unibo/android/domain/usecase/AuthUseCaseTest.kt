...
class AuthUseCaseTest {
    ...
    @Test
    fun `login - successo restituisce Result success`() =
        runTest {
    ...
    @Test
    fun `login - credenziali errate restituisce Result failure`() =
        runTest {
    ...
    @Test
    fun `register - successo delega al repository`() =
        runTest {
    ...
    @Test
    fun `register - email già registrata restituisce failure`() =
        runTest {
            whenever(repo.register("Anna", "Bianchi", "anna@test.it", "pass1234"))
    ...
    @Test
    fun `logout - invoca repository logout`() =
        runTest {
    ...
    @Test
    fun `logout - logout locale riuscito anche se API fallisce`() =
        runTest {
    ...
    @Test
    fun `isLoggedIn - emette il valore restituito dal repository`() =
        runTest {
