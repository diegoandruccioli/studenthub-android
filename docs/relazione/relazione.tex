...
override suspend fun refreshObiettivi(): Result<Unit> = withContext(ioDispatcher) {
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.45\textwidth]{obiettivi_screen.png}
        \caption{Schermata Obiettivi (\texttt{ObiettiviScreen}): visualizzazione del catalogo dei badge di gamification con indicazione dello stato di completamento, ottenuto sincronizzando dinamicamente i traguardi sbloccati dall'utente.}
        \label{fig:obiettivi}
    \end{figure}
